  ...
  if (data) {
    return (
      <div>
        ...
        <DetailDropDown title="coordinates" data={{ longtitude: data.coord.lon, latitude: data.coord.lat }} />
        <DetailDropDown
          title="main"
          data={{
        ...
        />
        <DetailDropDown title="weather" data={{ description: data.weather[0].description, icon: data.weather[0].icon }} />
        <DetailDropDown title="wind" data={{ wind_direction: data.wind.deg, 'wind speed': data.wind.speed }} />
      </div>
    );
  }
}

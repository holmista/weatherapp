      ...
      <div className={`flex flex-col items-center ${theme === 'light' ? 'bg-slate-100' : 'bg-slate-600 text-white'} h-screen`}>
       ...
       focus:border-indigo-500  border-b-2 transition duration-300 md:w-1/5"
        ...
        <button
          ...
          type="button"
          disabled={disable}
          className="bg-indigo-400 mt-6 w-40 p-2 hover:cursor-pointer hover:bg-indigo-600
      text-white text-lg rounded-md transition duration-300"
        >
          {loading && (
          <svg role="status" className="inline mr-2 w-6 h-6 text-white animate-spin fill-gray-400 p-1" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">

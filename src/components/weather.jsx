...
export default function Weather() {
  ...
  return (
    <div className="flex flex-col items-center justify-ceneter min-h-screen  overflow-auto  sm:h-screen">

      <div className="w-screen flex justify-center sm:flex sm:justify-end sm:pr-48">
        <button onClick={handleMeasure} type="button" className="p-1 shrink-0 mt-10 bg-indigo-300 w-40 h-14 rounded-lg">
